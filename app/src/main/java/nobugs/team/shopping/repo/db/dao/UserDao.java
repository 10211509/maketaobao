 ...
 * DAO for table USER.
 */
public class UserDao extends AbstractDao<UserPo, Integer> {
    ...
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(UserPo entity, long rowId) {
        return entity.getId();
    }

    /** @inheritdoc */
    @Override
    public Integer getKey(UserPo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
