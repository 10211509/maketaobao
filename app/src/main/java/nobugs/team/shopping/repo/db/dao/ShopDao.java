 ...
 * DAO for table SHOP.
*/
public class ShopDao extends AbstractDao<ShopPo, Integer> {

    public static final String TABLENAME = "SHOP";

    /**
     * Properties of entity ShopPo.<br/>
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ShopPo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(ShopPo entity) {
    ...
    /** @inheritdoc */
    @Override
    public ShopPo readEntity(Cursor cursor, int offset) {
        ShopPo entity = new ShopPo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ShopPo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(ShopPo entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public Integer getKey(ShopPo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected ShopPo loadCurrentDeep(Cursor cursor, boolean lock) {
        ShopPo entity = loadCurrent(cursor, 0, lock);
    ...
    public ShopPo loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<ShopPo> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<ShopPo> list = new ArrayList<ShopPo>(count);
    ...
    protected List<ShopPo> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<ShopPo> queryDeep(String where, String... selectionArg) {
