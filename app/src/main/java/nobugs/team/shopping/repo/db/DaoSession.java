...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        registerDao(ProductTypePo.class, productTypeDao);
        registerDao(ProductPo.class, productDao);
        registerDao(ShopPo.class, shopDao);
        registerDao(OrderPo.class, orderDao);
    }
