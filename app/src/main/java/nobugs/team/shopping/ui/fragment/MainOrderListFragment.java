...
public class MainOrderListFragment extends BaseFragment<MainOrderPresenter> implements MainOrderView {
    ...
    public static MainOrderListFragment newInstance() {
        MainOrderListFragment fragment = new MainOrderListFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public MainOrderListFragment() {
    ...
    protected void initView() {
        ...
        mTabsAdapter.addTab(mTabHost.newTabSpec("进行中").setIndicator("进行中"),
                OrderInprogressFragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("已完成").setIndicator("已完成"),
                OrderFinishedFragment.class, null);
    }

    @Override
    protected MainOrderPresenter initPresenter() {
        return new MainOrderPresenterImpl(this);
    }
