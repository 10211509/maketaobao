...
public class ProductTypeDao extends AbstractDao<ProductType, Integer> {
    ...
    */
    ...
    @Override
    protected void attachEntity(ProductType entity) {
    ...
    protected ProductType loadCurrentDeep(Cursor cursor, boolean lock) {
        ProductType entity = loadCurrent(cursor, 0, lock);
    ...
    public ProductType loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<ProductType> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<ProductType> list = new ArrayList<ProductType>(count);
    ...
    protected List<ProductType> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<ProductType> queryDeep(String where, String... selectionArg) {
